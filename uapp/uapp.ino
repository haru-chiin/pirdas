...
void loop() {
  ...
  if (distance < 50) {
    ...
    analogDigitalWrite(buzzerPin, 0);
...
void perulangan() {
  analogDigitalWrite(buzzerPin, 255);
...
void analogDigitalWrite(int pin, int value) {
  // Pastikan nilai berada dalam rentang 0 hingga 255
  value = constrain(value, 0, 255);
  
  // Gunakan analogWrite untuk mengirimkan sinyal PWM
